...
<div class="checkout-container">
  ...
  <aside class="summary card">
    ...
    <ul>
      ...
      <li>
        <span id="buys" data-cont="${gvo.goods_name}(수량: ${account})" data-total="${total}" data-no="${gvo.no}" data-email="${mvo.email}" data-account="${account}" data-price="${gvo.goods_price}">수량</span>
        <span>${account}</span>
      </li>
    </ul>
